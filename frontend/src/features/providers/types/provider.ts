...
export interface Provider {
  ...
  location: Location; acceptsCash: boolean; acceptsMpesa: boolean
  verified: boolean; verificationStatus: ProviderVerificationStatus
...
export interface UpdateProviderPaymentMethodsRequest { acceptsCash: boolean; acceptsMpesa: boolean }
